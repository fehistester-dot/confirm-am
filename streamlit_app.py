...
# 3. Styling (STAYS THE SAME + New Trust Bar Style)
st.markdown("""
    <style>
...
# --- SHOPPING MALL (ADDED TRUST BAR ONLY) ---
if menu == "🛍️ Shopping Mall":
    ...
    # NEW: Trust Bar (Added right at the top)
    st.markdown("""
        <div class="trust-bar">
...
# --- SAFETY & ESCROW (UPDATED WITH YOUR REASONS) ---
...
# --- MERCHANT PORTAL (STAYS THE SAME) ---
